...
> 🔗 [**Скачать demo.mp4 из GitHub Releases**](https://github.com/ArtemChik103/autonomous-browser-ai-agent/releases/download/v1.0.0/demo.mp4) | [**demo.mp4 в репозитории**](demo.mp4)
